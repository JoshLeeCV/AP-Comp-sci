		...
		*/
		while(true){
			...
			if (choice.equals("file")) {
                ...
                int count = checksArray(arr, wordcheck); 
                System.out.println("The word " + "'" + wordcheck + "'" + " appears " + count + " times.");
            }
                ...
                System.out.println("This does not work. Enter again.");
            }
